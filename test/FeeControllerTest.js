...
// Tests that XAG fee controller capabilities function correctly.
contract('Fee Controller XAG', function ([_, admin, feeController, feeRecipient, recipient, otherAddress, owner]) {
    ...
    beforeEach(async function () {
        ...
        await proxiedXAG.initializeBalance(owner, ownerStartingBalance);
